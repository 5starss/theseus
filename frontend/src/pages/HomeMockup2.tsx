...
export default function HomeMockup() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-[#f4f7ff] via-white to-[#f9fafb] text-[#1e293b] font-sans overflow-x-hidden relative pb-36 md:pb-40">
      ...
      <footer className="fixed bottom-0 left-0 w-full z-45 bg-white/90 backdrop-blur-xl border-t border-slate-200/80 shadow-[0_-12px_35px_rgba(15,23,42,0.04)] transition-all">
        ...
        <div className="w-full border-b border-slate-200/50 py-3 px-4 md:px-8 select-none">
          <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
            ...
            <div className="w-full overflow-hidden flex items-center justify-start px-5 py-1">
              <div className="flex flex-wrap items-center gap-8 md:gap-16 transition-all duration-1000 opacity-80">
                {/* 삼성 로고 이미지 */}
                <img
                  src="/samsung.png"
                  alt="삼성 로고"
        ...
        {/* [2단] 슬림하고 정갈한 싸피증권 저작권 / 약관 링크 영역 */}
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4 py-3 md:py-4 px-4 md:px-8 text-slate-500 text-xs text-left">
