            ...
            <DialogContent className="max-w-2xl p-0 overflow-hidden border-none rounded-3xl shadow-2xl">
                ...
                <ScrollArea className="max-h-[65vh] pl-6 pr-7 pt-1 pb-4">
                    <div className="space-y-10">
                        ...
                        <div className="space-y-12">
                            ...
                            <section className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center font-black text-sm shrink-0">1</div>
                            ...
                            <section className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center font-black text-sm shrink-0">2</div>
                                    <h4 className="font-bold text-slate-900 text-lg flex items-center gap-2">
                                        관심종목 등록하기
                                    </h4>
                                </div>
                            ...
                            <section className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center font-black text-sm shrink-0">3</div>
                                    <h4 className="font-bold text-slate-900 text-lg flex items-center gap-2">
                                        AI 투자 성향 & 분석 설정
                                    </h4>
                                </div>
                        ...
                        {/* 마무리 */}
                        <section className="bg-indigo-50 p-6 rounded-3xl border border-indigo-100 relative overflow-hidden">
                            <h4 className="font-bold text-indigo-900 text-lg mb-2 flex items-center gap-2">
                                ✅ 모든 설정 완료!
                            </h4>
                            <p className="text-indigo-800 text-sm leading-relaxed">
                                설정 끝나면 AI가 분석 결과에 따라 관심종목 중에서 최적의 타이밍에 자동으로 매수와 매도를 진행합니다. 이제 실시간 차트를 계속 확인하지 않아도 AI가 쉬지 않고 시장을 관리합니다.
                            </p>
                        </section>
                ...
                <div className="p-6 bg-slate-50 flex justify-end border-t border-slate-100">
                    <button
                        onClick={onClose}
                        className="px-5 py-3 bg-indigo-600 text-white font-black rounded-2xl hover:bg-indigo-700 transition-all active:scale-95 shadow-lg shadow-indigo-200"
                    >
                        확인
                    </button>
                </div>
