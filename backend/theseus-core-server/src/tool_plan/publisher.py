...
class KafkaToolPlanEventPublisher(ToolPlanEventPublisher):
    ...
    async def start(self) -> None:
        ...
        logger.info("Kafka ToolPlan event producer started.")
    ...
    async def stop(self) -> None:
        ...
        self._producer = None
        logger.info("Kafka ToolPlan event producer stopped.")
